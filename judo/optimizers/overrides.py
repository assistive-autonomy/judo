...
def set_default_fr3_handover_overrides() -> None:
    """Sets the default task-specific controller config overrides for the fr3 handover task."""
    set_config_overrides(
        "fr3_handover",
        PredictiveSamplingConfig,
        {
...
def set_default_fr3_handover_hand_only_overrides() -> None:
    """Sets the default task-specific controller config overrides for the fr3 handover hand-only task."""
    set_config_overrides(
        "fr3_handover_hand_only",
        PredictiveSamplingConfig,
        {
            "num_nodes": 8,
            "num_rollouts": 64,
